...
public class RobotContainer {
  ...
  private Command generateRamseteCommand() {
    ...
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        List.of(
            new Translation2d(0.2286*1.95, 0.2286),
            new Translation2d(0.2286*1.5, 0.2286*2),
            new Translation2d(0.2286*-0.4125, 0.2286),
            new Translation2d(-0.2286+0.05, 0.2286*2.325)
        ),
